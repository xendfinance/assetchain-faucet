...
export class ConnectionAlert extends React.PureComponent<
  IConnectionAlertProps,
  IConnectionAlertState
> {
  ...
  public render(): React.ReactElement<IConnectionAlertProps> {
    ...
    let timeout = this.props.faucetConfig.modules.pow.powIdleTimeout
      ? this.props.disconnectTime +
    ...
    if (this.props.initialConnection)
      ...
      errorCaption =
        "Connection to faucet server has been lost. Reconnecting...";
      ...
      <div className="connection-status">
        ...
        {now - this.props.disconnectTime > 10 && timeout > 0 ? (
          <div className="reconnect-info">
            Please check your internet connection. The connection needs to be
            restored within the next {renderTimespan(timeout, 2)} or your
