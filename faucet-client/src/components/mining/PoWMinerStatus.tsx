...
export class PoWMinerStatus extends React.PureComponent<
      ...
      <div className="grid pow-status">
        ...
        <div className="row pow-status-addr">
          ...
          <div className="col-12">
            <div className="status-value">
              {this.props.powSession.getTargetAddr()}
            </div>
          </div>
        </div>
        <div className="row pow-status-top">
          ...
          <div className="col-6">
            ...
            <div className="status-value">
              {Math.round(this.state.hashRate * 100) / 100} H/s
            </div>
          </div>
        </div>
        ...
        <div className="row pow-status-other">
          ...
          <div className="col-6">
            <div className="status-value">
              {renderTimespan(sessionLifetime)}
            </div>
          </div>
        </div>
        <div className="row pow-status-other">
        ...
        <div className="row pow-status-other">
          ...
          <div className="col-6">
            <div className="status-value">
              {toReadableAmount(
                (BigInt(this.state.balance || 0) * 3600n) /
                  BigInt(miningTime || 1),
                this.props.faucetConfig.faucetCoinDecimals,
                this.props.faucetConfig.faucetCoinSymbol,
              )}
          ...
          <div className="row pow-status-other">
              ...
              <div className="status-value">
                {this.props.passportScoreInfo ? (
                  <span className="boost-value">
                    +{" "}
                    {Math.round(
                      (this.props.passportScoreInfo.factor - 1) * 100,
                    )}
                    %
                  </span>
                ) : (
            ...
            <div className="col-3 pow-passport-controls">
              <button
                type="button"
                className="btn btn-primary btn-sm"
                onClick={() => this.props.openPassportInfo()}
              >
                Boost
              </button>
            </div>
